  ...
  try {
    await fetch(`${url}/rest/v1/words`, {
      ...
      headers: {
        ...
        // merge-duplicates: update existing row if word already there
...
function normalizeResult(obj) {
  return {
    ...
    synonyms:     (obj.synonyms          || []).slice(0, 7),
    antonyms:     (obj.antonyms          || []).slice(0, 5),
...
Use these exact camelCase key names:
{
  ...
  "forms":          ["inflected/derived forms with POS: 'eloquently (adv)', 'eloquence (noun)'"],
  "examples":       ["up to 5 sentences — formal, academic, business, literary, everyday"],
  "synonyms":       ["4-6 synonyms most→least common"],
...
Use these exact camelCase key names:
{
  ...
  "forms":          ["All inflected/derived forms with POS label"],
  "examples":       [
    "Formal/academic sentence",
    "Business/professional sentence",
    "Literary or descriptive sentence",
    "Conversational/everyday sentence",
    "Nuanced or idiomatic sentence"
  ],
  "synonyms":       ["5-6 synonyms most→least common"],
  "antonyms":       ["3-4 antonyms"],
  "register":       "Formal | Academic | Business | Literary | Neutral | Informal | Slang",
